            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="float-end">
                        <a href="{{ Route('trainings.edit', ['training_id' => $training->id])}}" class="text-sucess ml-auto"><i class="fa-solid fa-edit"></i></a>
                    </span>
                </div>
                <div class="card-body">
                        <div class="row">
                                        ...
                                        <div class="card-body">
                                            <table {{-- id="datatable-Automatic" --}} class="object-table table table-sm table-bordered table-striped" style="width: 100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><a href="{{ Route('users.view', ['id'=>$user->id])}}">{{ $user->name ?? '--'}}</a></td>
                                                        <td><a href="{{ Route('users.view', ['id'=>$user->id])}}">{{ $user->email ?? '--'}}</a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
